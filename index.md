...
in Japan. A station is specified by a pair of `prec_no` (area) and
`block_no` (station).

気象庁は，日本の各地点の詳細データ (年別・月別・日別・時別・10分別)
を公開しています． 地点は `prec_no` (地域) と `block_no` (観測地点)
の組で指定します．
...
![](reference/figures/README-temperature-1.png)
...
![](reference/figures/README-precipitation-1.png)
...
![](reference/figures/README-except_japan-1.png)
...
![](reference/figures/README-all_data-1.png)
...
![](reference/figures/README-compare_japan-1.png)
