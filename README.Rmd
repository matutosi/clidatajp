...
However, I strongly recommend you to use data(climate_world) and data(climate_jp) when using mean temperature and precipitation. 
...
remotes::install_github("matutosi/clidatajp")
```
